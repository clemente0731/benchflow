...
def main():
    parser = argparse.ArgumentParser(description="Batch execute black format on Python files.")
    parser.add_argument("mode", choices=["format", "check_format"], default="format", help="Choose the mode: format or check_format")
